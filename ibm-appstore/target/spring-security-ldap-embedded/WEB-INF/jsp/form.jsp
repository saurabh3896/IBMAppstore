...
<html>
	...
	<s: property value="UploadController.file_name" />
    ...
    <script type='text/javascript'>
      ...
      $('#accumulator__').click(function(){
				$('#switch_input').val('itsaccumulator!!!');
			});

			$('#codelist__').click(function(){
				$('#switch_input').val('itscodelist!!!');
			});
    ...
    <body style="background-color:#211931">
    	<div id="marquee">
    ...
    <a href="#" id="attach">
      <div id="attach" value='Reset' id='reset' class="checkBox" style="margin-left:150px;margin-top:50px; width:140px">
    			Upload File
		...
		<div class="checkBox" style="margin-left:800px;margin-top:-80px; width:140px">
  			Reset File
  			<svg width="140" height="65" viewBox="0 0 140 65" xmlns="http://www.w3.org/2000/svg">
    			<rect x="10" class="button" width="128.8" height="63.9"/>
    			<rect x="0" y="22.5" class="box" width="20" height="20"/>
						...
						<div class="ch-item">
                            <div class="ch-info">
								...
								<div class="ch-info-back">
                                	...
                                	<form id='uploadForm'>
                                    	<center>
                                    		<input type='button' value="Choose File" id='submit' style = 'margin:75px;' />
                                    	</center>
                                	</form>
                            	</div>
                        	</div>
